...
const Footer = () => {
  ...
  return (
    <>
      <div className="w-full bg-[#F5F5DE] h-[15px]"></div>
      <div className="w-full bg-cover bg-center bg-no-repeat bottom-0">
        <div className=" relative max-w-[1500px] bg-primary mx-auto md:px-[5rem] px-[20px] pt-[65px] pb-[66px] min-h-[60vh] text-white">
          ...
          <div className=" mt-10 pt-[16px] border-t-2 border-white w-full flex flex-wrap justify-between items-center gap-3">
            <h3 className="font-bold text-body-tiny">
