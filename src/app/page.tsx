...

{
  ...
  subHeader="Register or Login to Reserve"
  description="You’re one step from reserving the [entire apartment located in Wuse 2]. You can login or create an account to do so or continue as a guest user."
