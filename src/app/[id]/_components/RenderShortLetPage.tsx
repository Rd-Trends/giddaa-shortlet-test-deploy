...
const SectionTitle = ({ title }: { title: string }) => {
  return (
    <h2
      className={
        " text-heading-4 md:text-heading-3 text-primary font-bold font-secondary relative pb-2"
      }>
      {title}
      <span className="absolute left-0 w-[92px] h-0.5 rounded-full bg-primary bottom-0" />
    </h2>
  );
};
